        ...
        <>
            <div className=" inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto md:ml-6 sm:pr-0">
                ...
                <div className='hidden lg:block'>
                    <button type="button" className='text-lg font-semibold bg-transparent py-2 px-3 lg:px-9 navbutton rounded-full hover:bg-navyblue hover:text-white' onClick={openModal}>
                        Iniciar sesión
                    </button>
                </div>
                <button type="button" className='text-lg font-semibold bg-transparent py-2 px-3 lg:px-9 navbutton rounded-full hover:bg-navyblue hover:text-white ml-4' onClick={openModal}>
                    Registrarse
                </button>
            </div>
